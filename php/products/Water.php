...
<body onload = "loadQuantity('waterQuantity'); updateItemPrice('water')">
    ...
    <div class="media product" style="margin-top: 0; margin-left: 5%">
        <img src="Images/water.jpeg" width=250px class="media-list-image mr-3" alt="Eska Water">
        <div class="media-body">
            <div class="textblack" style="color: black">
                <h5 class="mt-0">Eska Water</h5>
                <p>Weight: 10L</p>
                ...
                <div class="mr-5" id="collapse" style = "display: none; max-height: 0; overflow:hidden; transition: max-height 0.35s ease-out">
                    <div class="card card-body">
                        ...
                        <h6>Storage</h6>
                        <p>Once opened, use within 3 days for better quality.</p>
                    </div>
                </div>
            </div>
