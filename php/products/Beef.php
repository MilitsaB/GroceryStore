...
<body onload="document.getElementById('beefQuantity').value = getSavedValue('beefQuantity');">
    ...
    <div class="media product" style = "margin-top: 0; margin-left: 5%">
        <img src="Images/beef.jpg" class="media-list-image mr-3" alt="Lean Ground Beef">
        <div class="media-body">
            <div class="textblack" style="color: black">
                <h5 class="mt-0">Lean Ground Beef</h5>
                <p>Weight: 454g</p>
                <p>Price: 15.45$/ kg</p>
                <p>
