<!DOCTYPE html>
    <html>
        <head>
            <title>Lactantia Salted Butter</title>
        ...
        <body onload = "loadQuantity('butterQuantity'); updateItemPrice('butter')">
            ...
            <div class="media product" style="margin-top: 0; margin-left: 5%">
                <img src="Images/SaltedButter.png" class="media-list-image mr-3" alt="Lactantia Salted Butter">
                <div class="media-body">
                <div class="textblack" style="color: black">
                  <h5 class="mt-0">Lactantia Salted Butter</h5>
                    <p>454g</p>
                    ...
                    <div class="mr-5" id="collapse" style = "display: none; max-height: 0; overflow:hidden; transition: max-height 0.35s ease-out">
                        <div class="card card-body">
                            ...
                            <p>544-379-65</p>
                            <h6>Description</h6>
                            <p>Lactantia salted country churned butter is a locally produced, rich and smooth butter, great on a toast or for cooking.</p>
                            <h6>Ingredients</h6>
                            <p>Cream, Salt, Milk</p>
                            <h6>Storage</h6>
