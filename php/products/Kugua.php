<!DOCTYPE html>
    <html>
        ...
        <body onload="document.getElementById('kuguaQuantity').value = getSavedValue('kuguaQuantity');">
            ...
            <div class="media product" style="margin-top: 0; margin-left: 5%" >
                <img src="Images/kugua.png" class="media-list-image mr-3" alt="Bitter Melon" width="50%">
                <div class="media-body">
                    <div class="textblack" style="color: black">
                  <h5 class="mt-0">Bitter Melon, 1 Gourd</h5>
                    <p>Weight: 280g</p>
                    <p>Price: $2.49</p>
                    <p>
                        <button class="btn green-button" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                            More Description
                        </button>
                    </p>
                    <div class="collapse mr-5" id="collapseExample">
                        <div class="card card-body">
                            ...
                            <p>086-250-70</p>
                            <h6>Description</h6>
                            <p>Organically grown bitter melon, free of pesticides</p>
                            <h6>Ingredients</h6>
                            <p>Bitter Melon</p>
                            <h6>Storage</h6>
                            <p>Store in the fridge, eat within a week</p>
                        </div>
                    </div>
