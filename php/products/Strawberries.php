<!DOCTYPE html>
    <html>
        ...
        <body onload = "loadQuantity('strawberriesQuantity'); updateItemPrice('strawberries');">
            ...
            <div class="media product" style="margin-top: 0; margin-left: 5%">
                <img src="Images/Strawberries.png" class="media-list-image mr-3" alt="Fresh Strawberries">
                <div class="media-body">
                    <div class="textblack" style="color: black">
                  <h5 class="mt-0">Strawberries</h5>
                    <p>Weight: 400g</p>
                    <p name = "strawberriesPrice" data-price="4.0">Price: $4.00</p>
                    <p>
                    ...
                    <div class="mr-5" id="collapse" style = "display: none; max-height: 0; overflow:hidden; transition: max-height 0.35s ease-out">
                        <div class="card card-body">
                            ...
                            <p>544-380-66</p>
                            <h6>Description</h6>
                            <p>Locally produced fresh strawberries are sweet and nutritious sold in 400g containers</p>
                            <h6>Ingredients</h6>
                            <p>Strawberries</p>
                            <h6>Storage</h6>
