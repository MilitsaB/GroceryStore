...
<body onload= "document.getElementById('baconQuantity').value = getSavedValue('baconQuantity');">
    <script>document.getElementById("baconQuantity").value = getSavedValue("baconQuantity");</script>
    ...
    <div class="media product" style="margin-top: 0 ; margin-left: 5%">
        <img src="Images/bacon.jpeg" width=330px class="media-list-image mr-5" alt="Sliced Bacon">
        <div class="media-body">
            <div class="textblack" style="color: black">
                <h5 class="mt-0">Sliced Bacon</h5>
                <p>Weight: 454g</p>
                <p>Price: 6.45$</p>
                <p>
                ...
                <div class="collapse mr-5" id="collapseExample">
                    <div class="card card-body" style="background-color: rgb(210, 235, 182)">
                        ...
                        <p>684-723-32</p>
                        <h6>Description</h6>
                        <p>Great Value thick sliced naturally smoked bacons</p>
                        <h6>Ingredients</h6>
                        <p>Pork, water, salt, sugar, sodium phosphate, sodium erythorbate, sodium nitrite, smoke.
                        </p>
                        <h6>Storage</h6>
