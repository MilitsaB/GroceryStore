<!DOCTYPE html>
    <html>
        ...
        <body onload = "loadQuantity('milkQuantity'); updateItemPrice('milk');">
            ...
            <div class="media product" style="margin-top: 0; margin-left: 5%">
                <img src="Images/QuebonMilk.png" class="media-list-image mr-3" alt="Quebon 2% M.F. Partially Skimmed Milk">
                <div class="media-body">
                    <div class="textblack" style="color: black">
                  <h5 class="mt-0">Quebon 2% M.F. Partly Skimmed Milk</h5>
                    <p>1L</p>
                    ...
                    <div class="mr-5" id="collapse" style = "display: none; max-height: 0; overflow:hidden; transition: max-height 0.35s ease-out">
                        <div class="card card-body">
                            ...
                            <p>544-389-65</p>
                            <h6>Description</h6>
                            <p>Quebon 2% M.F. Partially Skimmed Milk is a locally produced, vitamin D3 fortified milk drink.</p>
                            <h6>Ingredients</h6>
                            <p>Milk, Vitamin D3</p>
                            <h6>Caution</h6>
