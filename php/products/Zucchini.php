<!DOCTYPE html>
    <html>
        ...
        <body onload = "loadQuantity('zucchiniQuantity'); updateItemPrice('zucchini');">
            ...
            <div class="media product" style="margin-top: 0; margin-left: 5%">
                <img src="Images/Zucchini.png" class="media-list-image mr-3" alt="Zucchini">
                <div class="media-body">
                    <div class="textblack" style="color: black">
                  <h5 class="mt-0">Zucchini</h5>
                    <p>1 unit</p>
                    <p name = zucchiniPrice data-price = "0.75">Price: $0.75</p>
                    <p>
                    ...
                    <div class="mr-5" id="collapse" style = "display: none; max-height: 0; overflow:hidden; transition: max-height 0.35s ease-out">
                        <div class="card card-body">
                            ...
                            <p>544-279-65</p>
                            <h6>Description</h6>
                            <p>The zucchini are locally grown, fresh, and healthy. Great in any dish.</p>
                            <h6>Ingredients</h6>
                            <p>Zucchini</p>
                            <h6>Storage</h6>
