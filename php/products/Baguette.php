    ...
    <html>
        ...
        <body onload ="document.getElementById('baguetteQuantity').value = getSavedValue('baguetteQuantity');">
            ...
            <div class="media product" style="margin-top: 0; margin-left: 5%">
                <img src="Images/baguette.png" class="media-list-image mr-3" alt="Baguette" width="50%">
                <div class="media-body">
                <div class="textblack" style="color: black">
                  <h5 class="mt-0">Baguette, loaf</h5>
                    <p>Weight: 250g</p>
                    <p>Price: $2.49</p>
                    <p>
                    ...
                    <div class="collapse mr-5" id="collapseExample">
                        <div class="card card-body">
                            ...
                            <p>799-455-72</p>
                            <h6>Description</h6>
                            <p>Daily fresh French style baguette</p>
                            <h6>Ingredients</h6>
                            <p>Flour, Active Dry Yeast, Vegetable Oil, Conservation Agents</p>
                            <h6>Storage</h6>
                            <p>Store in a cool dry place, eat within 3 days or freeze</p>
                        </div>
                    </div>
