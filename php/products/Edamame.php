    ...
    <html>
        ...
        <body onload="document.getElementById('edamameQuantity').value = getSavedValue('edamameQuantity');">
            ...
            <div class="media product" style="margin-top: 0; margin-left: 5%">
                <img src="Images/edamame.png" class="media-list-image mr-3" alt="Edamame">
                <div class="media-body">
                    <div class="textblack" style="color: black">
                  <h5 class="mt-0">Edamame</h5>
                    <p>Weight: 600g</p>
                    <p>Price: $2.99</p>
                    <p>
                    ...
                    <div class="collapse mr-5" id="collapseExample">
                        <div class="card card-body">
                            ...
                            <p>086-223-55</p>
                            <h6>Description</h6>
                            <p>Imported organic edamame. Can be eaten as snack.</p>
                            <h6>Ingredients</h6>
                            <p>Soybeans</p>
                            <h6>Storage</h6>
                            <p>Store in fridge for a week or freeze</p>
                        </div>
                    </div>
