...
<body onload = "loadQuantity('juiceQuantity'); updateItemPrice('juice')">
    ...
    <div class="media product" style="margin-top: 0; margin-left: 5%">
        <img src="Images/juice.jpg" width=250px class="media-list-image mr-3" alt="Orange Juice">
        <div class="media-body">
            <div class="textblack" style="color: black">
                <h5 class="mt-0">Orange Juice</h5>
                <p>Weight: 1.54L</p>
                <p name = juicePrice data-price = "3.9">Price: 3.90$</p>
                <p>
                ...
                <div class="mr-5" id="collapse" style = "display: none; max-height: 0; overflow:hidden; transition: max-height 0.35s ease-out">
                    <div class="card card-body">
                        ...
                        <p>233-568-15</p>
                        <h6>Description</h6>
                        <p>Tropicana 100% pure and natural orange juice - no pulp</p>
                        <h6>Ingredients</h6>
                        <p>100% pure squeezed orange juice</p>
                        <h6>Storage</h6>
                        <p>Once opened, keep refrigerated.</p>
                    </div>
                </div>
            </div>
