...
<body onload = "loadQuantity('beerQuantity'); updateItemPrice('beer')">
    ...
    <div class="media product" style="margin-top: 0; margin-left: 5%">
        <img src="Images/beer.jpeg" width=250px class="media-list-image mr-3" alt="Coors Light Beer">
        <div class="media-body">
            <div class="textblack" style="color: black">
                <h5 class="mt-0">Coors Light Beer</h5>
                <p>Weight: 750ml</p>
                ...
                <div class="mr-5" id="collapse" style = "display: none; max-height: 0; overflow:hidden; transition: max-height 0.35s ease-out">
                    <div class="card card-body">
                        ...
                        <p>4% Alcohol Beer</p>
                        <h6>Ingredients</h6>
                        <p>Water, Barley Malt, Corn Syrup(Dextrose), Yeast, Hop Extract</p>
                        <h6>Storage</h6>
