...
<body onload="document.getElementById('cookieQuantity').value = getSavedValue('cookieQuantity');">
    ...
    <div class="media product" style="margin-top: 0; margin-left: 5%">
        <img src="Images/cookie.png" class="media-list-image mr-3" alt="Cookies" width="50%">
        <div class="media-body">
            <div class="textblack" style="color: black">
                <h5 class="mt-0">Cookies, box of 8</h5>
                <p>Weight: 350g</p>
                <p>Price: $4.99</p>
                <p>
                ...
                <div class="collapse mr-5" id="collapseExample">
                    <div class="card card-body">
                        ...
                        <p>799-247-27</p>
                        <h6>Description</h6>
                        <p>Homestyle decadent chocolate chip cookies</p>
                        <h6>Ingredients</h6>
                        <p>Margarine, Chocolate Chips, Brown Sugar, White Sugar, Eggs, Vanilla, Flour, Baking Soda, Salt
                        </p>
                        <h6>Storage</h6>
                        <p>Store in a cool dry place, eat within 5 days</p>
                    </div>
                </div>
