<!DOCTYPE html>
    <html>
        ...
        <body onload = "loadQuantity('eggplantQuantity'); updateItemPrice('eggplant');">
            ...
            <div class="media product" style="margin-top: 0; margin-left: 5%">
                <img src="Images/Eggplant.png" class="media-list-image mr-3" alt="Eggplant">
                <div class="media-body">
                    <div class="textblack" style="color: black">
                  <h5 class="mt-0">California Eggplant</h5>
                    <p>1 unit</p>
                    <p name = "eggplantPrice" data-price = "2.5">Price: $2.50 each</p>
                    <p>
                    ...
                    <div class="mr-5" id="collapse" style = "display: none; max-height: 0; overflow:hidden; transition: max-height 0.35s ease-out">
                        <div class="card card-body">
                            ...
                            <p>544-381-66</p>
                            <h6>Description</h6>
                            <p>Fresh California grown eggplants that vary in size and are sold inidivually </p>
                            <h6>Ingredients</h6>
                            <p>Strawberries</p>
                            <h6>Storage</h6>
