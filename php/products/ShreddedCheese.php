<!DOCTYPE html>
    <html>
        <head>
            <title>Kraft Shredded Mild Cheddar Cheese</title>
        ...
        <body onload = "loadQuantity('cheeseQuantity'); updateItemPrice('cheese')">
            ...
            <div class="media product" style="margin-top: 0; margin-left: 5%">
                <img src="Images/KraftCheddar.png" class="media-list-image mr-3" alt="Kraft Shredded Mild Cheddar Cheese">
                <div class="media-body">
                    <div class="textblack" style="color: black">
                  <h5 class="mt-0">Kraft Shredded Mild Cheddar Cheese</h5>
                    <p>226g</p>
                    ...
                    <div class="mr-5" id="collapse" style = "display: none; max-height: 0; overflow:hidden; transition: max-height 0.35s ease-out">
                        <div class="card card-body">
                            ...
                            <p>544-369-65</p>
                            <h6>Description</h6>
                            <p>Kraft Shredded Mild Cheddar Cheese is locally produced creamy cheese perfect for cooking</p>
                            <h6>Ingredients</h6>
                            <p>Cheddar cheese, potato starch, cellulose powder, calcium sulfate, natamycin. Contains: milk</p>
                            <h6>Storage</h6>
                            <p>Keep refrigirated</p>
                        </div>
                    </div>
