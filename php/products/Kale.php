<!DOCTYPE html>
    <html>
        ...
        <body onload="document.getElementById('kaleQuantity').value = getSavedValue('kaleQuantity');">
            ...
            <div class="media product" style="margin-top: 0; margin-left: 5%">
                <img src="Images/kale.png" class="media-list-image mr-3" alt="Kale" width="50%">
                <div class="media-body">
                    <div class="textblack" style="color: black">
                  <h5 class="mt-0">Kale, 1 bunch</h5>
                    ...
                    <div class="collapse mr-5" id="collapseExample">
                        <div class="card card-body">
                            ...
                            <p>086-753-09</p>
                            <h6>Description</h6>
                            <p>Locally grown organic kale, free of pesticides</p>
                            <h6>Ingredients</h6>
                            <p>Kale</p>
                            <h6>Storage</h6>
                            <p>Store in fridge for up to 5 days</p>
                        </div>
                    </div>
