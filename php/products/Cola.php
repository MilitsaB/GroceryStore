...
<body onload = "loadQuantity('colaQuantity'); updateItemPrice('cola')">
    ...
    <div class="media product" style="margin-top: 0; margin-left: 5%">
        <img src="Images/cola.jpg" class="media-list-image mr-3" alt="Coca-Cola">
        <div class="media-body">
            <div class="textblack" style="color: black">
                <h5 class="mt-0">Coca-Cola</h5>
                <p>Weight: 2L</p>
                ...
                <div class="mr-5" id="collapse" style = "display: none; max-height: 0; overflow:hidden; transition: max-height 0.35s ease-out">
                    <div class="card card-body">
                        ...
                        <p>233-348-92</p>
                        <h6>Description</h6>
                        <p>Coca-Cola classic soft drink</p>
                        <h6>Ingredients</h6>
                        <p>Carbonated water, sugar/glucose-fructose, caramel colour, phosphoric acid, natural flavour, caffeine</p>
                        <h6>Storage</h6>
                        <p>Once opened, keep refrigerated. Serve ice cold for maximum refreshment.</p>
                    </div>
                </div>
            </div>
